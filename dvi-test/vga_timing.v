...
-- 800x480    40MHz 60Hz 128   88  800   40   928    3     40 480   1  525
...
--
-- The Adafruit 5" Display is 800x480
-- 
-- ***************************************************************************/
...
// H front porch
//
// From display data sheet: https://cdn-shop.adafruit.com/datasheets/KD50G21-40NT-A1.pdf
//
// H display area 800 clocks
// DLCK freq 30 MHz (max 50 MHz)
// H line (tH) 889/928/1143 DCLKs
// HS pulse width 1/48/255 DCLKs
// HS Back Porch (blanking) 88 DCLK
// HS Front Porch 1/40/255 DCLKs
// HS Blanking 85/128/512 DCLKs
//
// V Display Area 480 tH
// VS Period Time 513/525/767 tH
// VS Pulse Width 3/3/255 tH
// VS Back Porch (blanking) 32 tH
// VS Front Porch 1/13/255 tH
// DE Mode Blanking 4/45/255 tH
//
//
//
// --                       HSYNC BP   H    FP  Htotal  VSYNC BP  V    FP Vtotal
// -- 800x480    40MHz 60Hz 128   88  800   40   928    3     40 480   1  525
// -spc- make these constants match the timing ^^
`define def_h_sync     16'd128  // hsync something
`define def_h_bp       16'd88   // hsync back porch
`define def_h_actv     16'd800  // hsync active
`define def_h_fp       16'd40   // hsync front porch
`define def_h_total    16'd928 // horizontal total
`define def_v_sync     16'd3
`define def_v_bp       16'd40
...
`define def_h_actv     16'd800  // hsync active
`define def_h_fp       16'd40   // hsync front porch
`define def_h_total    16'd1056 // horizontal total
